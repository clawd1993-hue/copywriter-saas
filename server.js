...
app.post('/api/checkout', async (req, res) => {
  ...
  p.set('custom_text[submit][message]', "You're getting Jimmy Lab — the total above is exactly what you'll pay today (including any promo code), then the monthly plan starts 30 days from now. Cancel anytime in one click. Pausing or cancelling never deletes your projects — your work is always safe.");
