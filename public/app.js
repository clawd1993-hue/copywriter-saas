...
const WEBINAR_SECTIONS = [
  ...
  { name: 'Secret 1 (🚗 — The New Way)', source: 'Step 6 secret (full formula) + Step 5 mechanism (demo it) → ends in proof' },
  { name: 'Secret 2 (🌍 — External)', source: '🌍 External belief — Step 6 secret + Step 5 mechanism → ends in proof' },
  { name: 'Secret 3 (🧠 — Internal)', source: '🧠 Internal belief — Step 6 secret + Step 5 mechanism → ends in proof' },
